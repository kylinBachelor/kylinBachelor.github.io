<template><div><h1 id="redis缓存击穿-穿透-雪崩" tabindex="-1"><a class="header-anchor" href="#redis缓存击穿-穿透-雪崩"><span>Redis缓存击穿-穿透-雪崩</span></a></h1>
<h2 id="_1-缓存一般使用思路简介" tabindex="-1"><a class="header-anchor" href="#_1-缓存一般使用思路简介"><span>1. 缓存一般使用思路简介</span></a></h2>
<p><img src="@source/notes/Redis/Redis缓存击穿-穿透-雪崩/assets/image-20241115103837372.png" alt="image-20241115103837372"></p>
<ol>
<li>客户端请求服务</li>
...
<p><img src="@source/notes/Redis/Redis缓存击穿-穿透-雪崩/assets/image-20241115105231198.png" alt="image-20241115105231198"></p>
...
<p><img src="@source/notes/Redis/Redis缓存击穿-穿透-雪崩/assets/image-20241115132125907.png" alt="image-20241115132125907"></p>
...
<p><img src="@source/notes/Redis/Redis缓存击穿-穿透-雪崩/assets/image-20241115132540596.png" alt="image-20241115132540596"></p>
