<template><div><p>消息预取机制（Prefetch Mechanism）是RabbitMQ中用于控制消息传递给消费者的一种机制。它定义了在一个信道上，消费者允许的最大未确认的消息数量。一旦未确认的消息数量达到了设置的预取值，RabbitMQ就会停止向该消费者发送更多消息，直到至少有一条未完成的消息得到了确认。</p>
<h1 id="一、思路" tabindex="-1"><a class="header-anchor" href="#一、思路"><span>一、思路</span></a></h1>
<ul>
<li>生产者发送100个消息</li>
<li>对照两种情况：
<ul>
...
<figure><img src="@source/notes/MQ/RabbitMQ/assets/image-20231107155915253.png" alt="image-20231107155915253" tabindex="0" loading="lazy"><figcaption>image-20231107155915253</figcaption></figure>
<ul>
<li>
<p>说明：</p>
<ul>
...
<figure><img src="@source/notes/MQ/RabbitMQ/assets/image-20231107160233539.png" alt="image-20231107160233539" tabindex="0" loading="lazy"><figcaption>image-20231107160233539</figcaption></figure>
<ul>
...
<figure><img src="@source/notes/MQ/RabbitMQ/assets/image-20231107160820062.png" alt="image-20231107160820062" tabindex="0" loading="lazy"><figcaption>image-20231107160820062</figcaption></figure>
<ul>
<li>接下来启动消费端程序，持续观察队列情况：</li>
</ul>
<figure><img src="@source/notes/MQ/RabbitMQ/assets/image-20231107160922632.png" alt="image-20231107160922632" tabindex="0" loading="lazy"><figcaption>image-20231107160922632</figcaption></figure>
<figure><img src="@source/notes/MQ/RabbitMQ/assets/image-20231107160936216.png" alt="image-20231107160936216" tabindex="0" loading="lazy"><figcaption>image-20231107160936216</figcaption></figure>
<figure><img src="@source/notes/MQ/RabbitMQ/assets/image-20231107160951639.png" alt="image-20231107160951639" tabindex="0" loading="lazy"><figcaption>image-20231107160951639</figcaption></figure>
<ul>
