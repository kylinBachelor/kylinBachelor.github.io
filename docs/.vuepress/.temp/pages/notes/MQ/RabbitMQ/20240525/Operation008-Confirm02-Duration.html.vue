<template><div><h1 id="一、测试非持久化交换机和队列" tabindex="-1"><a class="header-anchor" href="#一、测试非持久化交换机和队列"><span>一、测试非持久化交换机和队列</span></a></h1>
<h2 id="_1、创建非持久化交换机" tabindex="-1"><a class="header-anchor" href="#_1、创建非持久化交换机"><span>1、创建非持久化交换机</span></a></h2>
<p><img src="@source/notes/MQ/RabbitMQ/20240525/assets/image-20231106192621173.png" alt="image-20231106192621173"></p>
<p>创建之后，可以在列表中看到：</p>
<p><img src="@source/notes/MQ/RabbitMQ/20240525/assets/image-20231106192708597.png" alt="image-20231106192708597"></p>
<h2 id="_2、创建非持久化队列" tabindex="-1"><a class="header-anchor" href="#_2、创建非持久化队列"><span>2、创建非持久化队列</span></a></h2>
<p><img src="@source/notes/MQ/RabbitMQ/20240525/assets/image-20231106195216265.png" alt="image-20231106195216265"></p>
<p>创建之后，可以在列表中看到：</p>
<p><img src="@source/notes/MQ/RabbitMQ/20240525/assets/image-20231106195132627.png" alt="image-20231106195132627"></p>
<h2 id="_3、绑定" tabindex="-1"><a class="header-anchor" href="#_3、绑定"><span>3、绑定</span></a></h2>
<p><img src="@source/notes/MQ/RabbitMQ/20240525/assets/image-20231106195748319.png" alt="image-20231106195748319"></p>
...
<p><img src="@source/notes/MQ/RabbitMQ/20240525/assets/image-20231106200245531.png" alt="image-20231106200245531"></p>
...
<p><img src="@source/notes/MQ/RabbitMQ/20240525/assets/image-20231106200934265.png" alt="image-20231106200934265"></p>
...
<p>仍然还在：</p>
<p><img src="@source/notes/MQ/RabbitMQ/20240525/assets/image-20231106201123268.png" alt="image-20231106201123268"></p>
