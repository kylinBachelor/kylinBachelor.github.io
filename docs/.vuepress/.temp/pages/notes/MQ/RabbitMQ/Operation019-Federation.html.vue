...
<p><img src="@source/notes/MQ/RabbitMQ/assets/image-20240425152627455.png" alt="image-20240425152627455"></p>
<h2 id="_4、添加上游连接端点" tabindex="-1"><a class="header-anchor" href="#_4、添加上游连接端点"><span>4、添加上游连接端点</span></a></h2>
<p>在下游节点填写上游节点的连接信息：</p>
<p><img src="@source/notes/MQ/RabbitMQ/assets/image-20240425164430500.png" alt="image-20240425164430500"></p>
<p><img src="@source/notes/MQ/RabbitMQ/assets/image-20240425170737126.png" alt="image-20240425170737126"></p>
<h2 id="_5、创建控制策略" tabindex="-1"><a class="header-anchor" href="#_5、创建控制策略"><span>5、创建控制策略</span></a></h2>
<p><img src="@source/notes/MQ/RabbitMQ/assets/image-20240425164648385.png" alt="image-20240425164648385"></p>
<p><img src="@source/notes/MQ/RabbitMQ/assets/image-20240425165531899.png" alt="image-20240425165531899"></p>
...
<p><img src="@source/notes/MQ/RabbitMQ/assets/image-20240425170044297.png" alt="image-20240425170044297"></p>
...
<p><img src="@source/notes/MQ/RabbitMQ/assets/image-20240425170652201.png" alt="image-20240425170652201"></p>
<h3 id="_3发布消息执行测试" tabindex="-1"><a class="header-anchor" href="#_3发布消息执行测试"><span>③发布消息执行测试</span></a></h3>
<p>在上游节点向交换机发布消息：</p>
<p><img src="@source/notes/MQ/RabbitMQ/assets/image-20240425171228928.png" alt="image-20240425171228928"></p>
<p>看到下游节点接收到了消息：</p>
<p><img src="@source/notes/MQ/RabbitMQ/assets/image-20240425171308430.png" alt="image-20240425171308430"></p>
...
<p><img src="@source/notes/MQ/RabbitMQ/assets/image-20240425171911774.png" alt="image-20240425171911774"></p>
...
<p>创建组件后可以查看一下联邦状态，连接成功的联邦状态如下：</p>
<p><img src="@source/notes/MQ/RabbitMQ/assets/image-20240425172528528.png" alt="image-20240425172528528"></p>
<h3 id="_3执行测试" tabindex="-1"><a class="header-anchor" href="#_3执行测试"><span>③执行测试</span></a></h3>
<p>在上游节点向交换机发布消息：</p>
<p><img src="@source/notes/MQ/RabbitMQ/assets/image-20240425172625339.png" alt="image-20240425172625339"></p>
...
<p><img src="@source/notes/MQ/RabbitMQ/assets/image-20240425182437573.png" alt="image-20240425182437573"></p>
</div></template>
