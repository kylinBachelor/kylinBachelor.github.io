<template><div><h1 id="计划任务" tabindex="-1"><a class="header-anchor" href="#计划任务"><span>计划任务</span></a></h1>
<p>在windows系统中，我们可以通过任务计划程序来实现定时或者事件触发运行事务</p>
<h1 id="计划任务的创建" tabindex="-1"><a class="header-anchor" href="#计划任务的创建"><span>计划任务的创建</span></a></h1>
<p>windows中谁创建的计划任务谁能看到，A创建的计划任务默认B是看不到的</p>
<p>创建任务的命令行是  schtasks /create,后面再加上其它参数，比较常用的参数如下：</p>
<div class="language-sh line-numbers-mode" data-ext="sh" data-title="sh"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665">    /sc</span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">   计划任务类型，可选值为MINUTE、HOURLY、DAILY、WEEKLY、ONCE、ONSTART、ONLOGON、ONIDLE、MONTHLY、ONEVENT</span></span>
...
<span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665">    /F</span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">    如果指定的任务已经存在，则强制创建任务并抑制警告。</span></span></code></pre>

<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当使用了/sc参数为MINUTE,HOURLY,DAILY,WEEKLY时，我们需要指定/mo运行的间隔时间</p>
<ul>
<li>MINUTE: 1到1439分钟</li>
<li>HOURLY: 1-23小时</li>
<li>DAILY: 1-365天</li>
<li>WEEKLY: 1-52周</li>
<li>ONCE: 无修改者</li>
...
<li>ONIDLE: 无修改者</li>
<li>MONTHLY: 1-12或</li>
<li>FIRST,SECOND,THIRD,FOURTH,LAST,LASTDAY</li>
...
<p>查询计划任务的命令是 schtasks /query, 常用参数如下：</p>
<ul>
<li>/fo 指定格式输出，可选Table,List,或者CSV,没加此参数默认是table</li>
<li>/v 显示详细信息，如任务执行的程序位置等</li>
</ul>
<ol>
