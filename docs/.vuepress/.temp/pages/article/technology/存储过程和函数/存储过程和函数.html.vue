<template><div><h1 id="存储过程" tabindex="-1"><a class="header-anchor" href="#存储过程"><span>存储过程</span></a></h1>
<h2 id="_1-概述" tabindex="-1"><a class="header-anchor" href="#_1-概述"><span>1. 概述</span></a></h2>
<ol>
<li>
<p>存储过程就是一组经过预编译的SQL语句的封装。</p>
</li>
<li>
<p>执行过程：存储过程预先存储在 MySQL 服务器上，需要执行的时候，客户端只需要向服务器端发出调用存储过程的命令，服务器就可以把预先存储好的这一系列 SQL 语句全部执行。</p>
</li>
<li>
<p>好处：</p>
<ol>
...
<h2 id="_2-分类" tabindex="-1"><a class="header-anchor" href="#_2-分类"><span>2. 分类</span></a></h2>
<p>存储过程的参数类型可以是IN、OUT和INOUT, IN、OUT、INOUT 都可以在一个存储过程中带多个</p>
<ol>
<li>没有参数（无参数无返回）</li>
...
<h2 id="_3-创建存储过程" tabindex="-1"><a class="header-anchor" href="#_3-创建存储过程"><span>3. 创建存储过程</span></a></h2>
<div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375">CREATE</span><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375"> PROCEDURE</span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE"> 存储过程名(</span><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375">IN</span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">|</span><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375">OUT</span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">|INOUT 参数名 参数类型,...)</span></span>
...
<span class="line"><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375">END</span></span></code></pre>

<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-1-说明" tabindex="-1"><a class="header-anchor" href="#_3-1-说明"><span>3.1 说明</span></a></h3>
<ol>
<li>参数前面的符号的意思
<ol>
...
<div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375">LANGUAGE</span><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375"> SQL</span></span>
...
<span class="line"><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">| COMMENT </span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77">'</span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">string</span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77">'</span></span></code></pre>
...
<ul>
<li>
<p>BEGIN…END：BEGIN…END 中间包含了多个语句，每个语句都以（;）号为结束符。</p>
</li>
<li>
<p>. DECLARE：DECLARE 用来声明变量，使用的位置在于 BEGIN…END 语句中间，而且需要在其他语句使用之前进</p>
<p>行变量的声明。</p>
</li>
<li>
<p>SET：赋值语句，用于对变量进行赋值。</p>
</li>
<li>
<p>SELECT… INTO：把从数据表中查询的结果存放到变量中，也就是为变量赋值。</p>
</li>
</ul>
</li>
<li>
<p>需要设置新的结束标记</p>
<div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">DELIMITER 新的结束标记</span></span></code></pre>

<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>因为MySQL默认的语句结束符号为分号‘;’。为了避免与存储过程中SQL语句结束符相冲突，需要使用</p>
<p>DELIMITER改变存储过程的结束符。</p>
<p>比如：“DELIMITER //”语句的作用是将MySQL的结束符设置为//，并以“END //”结束存储过程。存储过程定</p>
<p>义完毕之后再使用“DELIMITER ;”恢复默认结束符。DELIMITER也可以指定其他符号作为结束符。</p>
<p>当使用DELIMITER命令时，应该避免使用反斜杠（‘\’）字符，因为反斜线是MySQL的转义字符。</p>
<p>示例：</p>
<div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">DELIMITER $</span></span>
...
<span class="line"><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375">END</span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE"> $</span></span></code></pre>

<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
</ol>
<h2 id="_4-举例" tabindex="-1"><a class="header-anchor" href="#_4-举例"><span>4. 举例</span></a></h2>
<div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">-- 第一个</span></span>
...
<span class="line"><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375">	END</span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676"> //</span></span>
<span class="line"><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">DELIMITER ;</span></span></code></pre>

<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-调用存储过程" tabindex="-1"><a class="header-anchor" href="#_5-调用存储过程"><span>5. 调用存储过程</span></a></h2>
<p>存储过程有多种调用方法。存储过程必须使用CALL语句调用，并且存储过程和数据库相关，如果要执行其他数据库中的存储过程，需要指定数据库名称，例如CALL dbname.procname。</p>
<div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375">CALL</span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE"> 存储过程名(实参列表</span></span></code></pre>

<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h3 id="_5-1-调用格式" tabindex="-1"><a class="header-anchor" href="#_5-1-调用格式"><span>5.1 调用格式</span></a></h3>
<div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">-- 1、调用in模式的参数：</span></span>
...
<span class="line"><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375">CALL</span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE"> sp1(@name);</span></span>
<span class="line"><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375">SELECT</span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE"> @name;</span></span></code></pre>

<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="函数" tabindex="-1"><a class="header-anchor" href="#函数"><span>函数</span></a></h1>
<h2 id="_1-语法" tabindex="-1"><a class="header-anchor" href="#_1-语法"><span>1. 语法</span></a></h2>
<div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375">CREATE</span><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375"> FUNCTION</span><span style="--shiki-light:#59873A;--shiki-dark:#80A665"> 函数名</span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">(参数名 参数类型,...)</span></span>
