import{_ as n,c as a,a as e,o as i}from"./app-NTPeDUMf.js";const l={};function p(c,s){return i(),a("div",null,s[0]||(s[0]=[e(`<blockquote><p>Compose 是 Docker 公司推出的一个软件，可以管理多个Docker容器组成一个应用。需要定义一个YAML格式的配置文件</p><p>docker-compose.yaml,写好多个容器之间的调用关系。然后只要一个命令就能同时 <strong>启动/关闭</strong> 这些容器。</p><p>Docker-compose 允许用户通过一个单独的docker-compose.yml文件来定义一组相关联的应用容器为一个项目。</p><p>即 <strong>容器的编排管理</strong>。</p></blockquote><div class="language-docker-compose line-numbers-mode" data-ext="docker-compose" data-title="docker-compose"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code><span class="line"><span>version: &#39;2.3&#39;</span></span>
