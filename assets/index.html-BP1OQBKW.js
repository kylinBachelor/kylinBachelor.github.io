import{_ as n,c as a,a as e,o as i}from"./app-BiyprLKk.js";const l={};function p(t,s){return i(),a("div",null,s[0]||(s[0]=[e(`<p>需要为Windows创建定时任务，按时执行bat文件</p><h2 id="以天为单位备份-autobackupmysqldbbyday-bat" tabindex="-1"><a class="header-anchor" href="#以天为单位备份-autobackupmysqldbbyday-bat"><span>以天为单位备份（ AutoBackUpMysqlDbByDay.bat）</span></a></h2><div class="language-bat line-numbers-mode" data-ext="bat" data-title="bat"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code><span class="line"><span>    @echo off</span></span>
