...
description: "初识"
date: 2024-06-12T18:43:26+08:00
draft: false
---
...
![image-20230410140908841](/img/Spring/SpringSecurity/初识/image-20230410140908841.png)
...
![image-20231130152247055](/img/Spring/SpringSecurity/初识/image-20231130152247055.png)

否则你的登录页会加载很久，并且看到的页面是这样的（登录按钮没有样式文件渲染，但是不影响登录功能的执行）

![image-20231130152345471](/img/Spring/SpringSecurity/初识/image-20231130152345471.png)
...
![filterchain](/img/Spring/SpringSecurity/初识/filterchain.png)
...
![delegatingfilterproxy](/img/Spring/SpringSecurity/初识/delegatingfilterproxy.png)
...
![filterchainproxy](/img/Spring/SpringSecurity/初识/filterchainproxy.png)
...
![securityfilterchain](/img/Spring/SpringSecurity/初识/securityfilterchain.png)
...
![multi securityfilterchain](/img/Spring/SpringSecurity/初识/multi-securityfilterchain-17016804731631.png)
...
![image-20231204230216259](/img/Spring/SpringSecurity/初识/image-20231204230216259.png)
...
![image-20231205164049257](/img/Spring/SpringSecurity/初识/image-20231205164049257.png)
...
![image-20231206022701725](/img/Spring/SpringSecurity/初识/image-20231206022701725.png)
...
![image-20231206023030864](/img/Spring/SpringSecurity/初识/image-20231206023030864.png)
...
![image-20230421184645177](/img/Spring/SpringSecurity/初识/image-20230421184645177.png)
...
![image-20231209011827867](/img/Spring/SpringSecurity/初识/image-20231209011827867.png)
...
![usernamepasswordauthenticationfilter](/img/Spring/SpringSecurity/初识/usernamepasswordauthenticationfilter-16822329079281.png)
...
![securitycontextholder](/img/Spring/SpringSecurity/初识/securitycontextholder.png)
...
![image-20231222124053994](/img/Spring/SpringSecurity/初识/image-20231222124053994.png)
...
![image-20231222131233025](/img/Spring/SpringSecurity/初识/image-20231222131233025.png)

##### 开放API

例如云冲印服务的实现

![image-20231222131118611](/img/Spring/SpringSecurity/初识/image-20231222131118611.png)

#### 现代微服务安全

##### 单块应用安全

![image-20231222152734546](/img/Spring/SpringSecurity/初识/image-20231222152734546.png)



##### 微服务安全

![image-20231222152557861](/img/Spring/SpringSecurity/初识/image-20231222152557861.png)
...
![image-20231220180422742](/img/Spring/SpringSecurity/初识/image-20231220180422742.png)



- 注册客户应用：客户应用如果想要访问资源服务器需要有凭证，需要在授权服务器上注册客户应用。注册后会**获取到一个ClientID和ClientSecrets**

![image-20231222203153125](/img/Spring/SpringSecurity/初识/image-20231222203153125.png)
...
​								![image-20231220185958063](/img/Spring/SpringSecurity/初识/image-20231220185958063.png)



![image-20231222203218334](/img/Spring/SpringSecurity/初识/image-20231222203218334.png)
...
![image-20231220190152888](/img/Spring/SpringSecurity/初识/image-20231220190152888.png)

![image-20231222203240921](/img/Spring/SpringSecurity/初识/image-20231222203240921.png)
...
![image-20231222203259785](/img/Spring/SpringSecurity/初识/image-20231222203259785.png)



### 1.5、授权类型的选择

![image-20231223020052999](/img/Spring/SpringSecurity/初识/image-20231223020052999.png)
...
![image-20231223164128030](/img/Spring/SpringSecurity/初识/image-20231223164128030.png)
...
![image-20230510154255157](/img/Spring/SpringSecurity/初识/image-20230510154255157.png)



填写应用信息：`默认的重定向URI模板为{baseUrl}/login/oauth2/code/{registrationId}`。registrationId是ClientRegistration的唯一标识符。

![image-20231221000906168](/img/Spring/SpringSecurity/初识/image-20231221000906168.png)

获取应用程序id，生成应用程序密钥：

![image-20230510163101376](/img/Spring/SpringSecurity/初识/image-20230510163101376.png)
...
![image-20230510165314829](/img/Spring/SpringSecurity/初识/image-20230510165314829.png)
...
![image-20231223203225688](/img/Spring/SpringSecurity/初识/image-20231223203225688.png)
